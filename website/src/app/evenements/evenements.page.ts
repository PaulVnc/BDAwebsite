...
export class EvenementsPage implements OnInit {
  ...
  events = [
    ...
    },
    {
      ...
      image:'/assets/images/asint_bda.jpg'
    },
    {
      ...
      image:'/assets/images/scene_ouverte.jpg'
    },
    {
    ...
    },
    {
      ...
      image:'/assets/images/concert_noel.jpg'
    },
    {
      name:'Soirée de Noël',
    ...
    {
      name:'Cabaret',
      description:'Durant le Festiv\'art, prends place un autre événement majeur du BDA : le Cabaret. Comme le nom l\'indique, le BDA organise un spectacle qui propose au public d\'y assister tout en partageant un repas préparé par Cook\'It. Le show est assuré par les différents clubs de l\'association : danse, théâtre, musique, et bien plus encore sont au programme.',
      image:'/assets/images/cabaret.jpg'
    },
    {
      name:'INT\'s Got Talent',
      description:'Le BDA, part le biais de l\'INT\'s Got Talent, invite les étudiants à montrer leur talent. À la différence d\'une scène ouverte, il s\'agit d\'un concours, il y a donc un jury et des prix pour les gagnants. De plus, cet événement ne s\'adresse pas aux clubs, mais directement aux étudiants désirant partager leur savoir-faire unique, dans des domaines parfois des plus étonnants.',
      image:'/assets/images/intgt.jpg'
    },
    {
